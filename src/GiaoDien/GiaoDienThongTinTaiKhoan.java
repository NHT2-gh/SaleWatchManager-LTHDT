    ...
    public GiaoDienThongTinTaiKhoan() {
        ...
        for (NhanVien nv : Controller.controller.arrayListNhanVien) {
            ...
            if (Controller.controller.tk.getMaNV().equals(nv.getMaNV())) {
                ...
                if(nv.getGtNV().equals("Nam")){
                    avt.setIcon(new ImageIcon(getClass().getResource("/Icon/Preppy-icon.png")));
                }else{
                avt.setIcon(new ImageIcon(getClass().getResource("/Icon/Office-Girl-icon.png")));
                }
