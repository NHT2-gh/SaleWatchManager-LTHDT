...
private void showSL(){
    ...
    private void showData() {
        ...
        for (DongHo dh : Controller.controller.arrayListDongHo) {
            ...
            myTable.addRow(new Object[]{dem, dh.getMaDH(), dh.getMaHang(), dh.getMaLoai(), dh.getTenDH(), Gia, dh.getSLTon(), dh.getTrangThai()});
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã đồng hồ", "Mã hãng", "Mã loại", "Tên đồng hồ", "Giá", "Số lượng tồn", "Trạng Thái"
            }
        ) {
...
private void insertCBBoxMaLoai(){
    new LoadData();
    for(LoaiDH ml : Controller.controller.arrayListLoaiDH){
    txtML.addItem(ml.getMaLoai());
    }
}
private void insertCBBoxMaHang(){
    new LoadData();
    for(HangDH mh : Controller.controller.arrayListHangDH){
    txtMH.addItem(mh.getMaHang());
    }
}
  /**
