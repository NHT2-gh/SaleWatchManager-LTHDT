...
public class GiaoDienNhanVien extends javax.swing.JFrame {
    ...
    private void showData() {
        ...
        for (NhanVien nv : Controller.controller.arrayListNhanVien) {
            dem++;
            myTable.addRow(new Object[]{dem, nv.getMaNV(), nv.getHoNV(), nv.getTenNV(), nv.getGtNV(), nv.getNsNV(), nv.getDcNV(), nv.getStdNV(), nv.getTrangThai()});
    ...
    private void initComponents() {
        ...
        tbl_nv.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã NV", "Họ ", "Tên", "Giới tính", "Ngày sinh", "Địa chỉ", "SDT", "Trạng Thái"
            }
        ) {
    ...
    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemActionPerformed
        ...
        if (TxtTen.getText().equals("") || txtDC.getText().equals("") || txtHoNV.getText().equals("") || txtMaNV.getText().equals("") || txtNS.getDate().equals("") || txtSDT.getText().equals("") || cbbTrangThai.getSelectedItem().equals(null)) {
            ...
            String CV = (String) cbbCV.getSelectedItem();

            NhanVien nv = new NhanVien(txtMaNV.getText(), txtHoNV.getText(), TxtTen.getText(), GT, txtNS.getDate(), txtDC.getText(), txtSDT.getText(), TT);
            TaiKhoan tk = new TaiKhoan(txtSDT.getText(), CV, txtMaNV.getText(), TT);
...
// TODO add your handling code here:
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuaActionPerformed
        ...
        if (TxtTen.getText().equals("") || txtDC.getText().equals("") || txtHoNV.getText().equals("") || txtMaNV.getText().equals("") || txtNS.getDate().equals("") || txtSDT.getText().equals("")) {
            ...
            String TT = (String) cbbTrangThai.getSelectedItem();
            String CV = (String) cbbCV.getSelectedItem();
            NhanVien nvv = new NhanVien(txtMaNV.getText(), txtHoNV.getText(), TxtTen.getText(), GT, txtNS.getDate(), txtDC.getText(), txtSDT.getText(), TT);
           TaiKhoan tk = new TaiKhoan(txtSDT.getText(), CV, txtMaNV.getText(), TT);
            for (NhanVien nv : Controller.controller.arrayListNhanVien) {
